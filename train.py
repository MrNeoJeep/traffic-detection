...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    if pretrained:
        with torch_distributed_zero_first(rank):
            logger.info('download if not found locally')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s_traffic.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/traffic.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=2)  # 修改训练的轮数
