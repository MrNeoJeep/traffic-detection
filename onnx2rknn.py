...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", '--onnx', type=str, default='weights/yolov5s.onnx', help='weights path')  # from yolov5/models/
    ...
    if opt.precompile:
        ret = rknn.build(do_quantization=True, dataset='./dataset.txt', pre_compile=True)  # pre_compile=True
    else:
